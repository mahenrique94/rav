...
const TableHeaderRow = () => createComponent('tr', null, [TableHeaderColumn('Name'), TableHeaderColumn('Age'), TableHeaderColumn('Birth')])
const TableHeader = () => createComponent('thead', null, TableHeaderRow())

const TableBodyColumn = name => createComponent('td', null, name)
const TableBodyRow = () => createComponent('tr', null, [TableBodyColumn('Matheus'), TableBodyColumn('25'), TableBodyColumn('25/05/1994')])
